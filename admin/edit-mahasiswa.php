                        ...
                        <div class="col mb-4">
                            ...
                            <div class="card shadow mb-4 p-3">
                                <form action="" method="post" enctype="multipart/form-data">
                                    ...
                                    <input type="hidden" name="foto" id="foto" value="<?= $mahasiswa['foto']; ?>">
                                    ...
                                    <div class="mb-3">
                                        <input type="number" id="nohp" name="nohp" placeholder="Nomor Telepon"  value="<?= $mahasiswa['nohp']; ?>">
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <a href="edit-gambar.php?nim=<?= $mahasiswa['nim']; ?>" class="my-3 btn btn-info">Ubah Gambar</a>
